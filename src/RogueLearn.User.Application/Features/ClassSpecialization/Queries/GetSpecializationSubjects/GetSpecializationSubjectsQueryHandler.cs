// RogueLearn.User/src/RogueLearn.User.Application/Features/ClassSpecialization/Queries/GetSpecializationSubjects/GetSpecializationSubjectsQueryHandler.cs
using AutoMapper;
using MediatR;
