...
namespace RogueLearn.User.Application.Tests.Features.Parties.Queries.GetPendingInvitations;
...
public class GetPendingInvitationsQueryHandlerTests
{
    ...
    public async Task Handle_ReturnsMapped(GetPendingInvitationsQuery query)
    {
        ...
        var invs = new List<PartyInvitation> { new() { Id = System.Guid.NewGuid(), PartyId = query.PartyId, InviteeId = System.Guid.NewGuid(), InviterId = System.Guid.NewGuid(), Status = InvitationStatus.Pending, Message = "m" } };
