...
public class ApproveDeclineLecturerVerificationRequestTests
{
    ...
    public async Task Approve_AssignsRoleAndUpdatesGuilds()
    {
        ...
        var sut = new ApproveLecturerVerificationRequestCommandHandler(reqRepo, profileRepo, roleRepo, userRoleRepo, guildRepo, logger);
    ...
    public async Task Decline_SetsRejectedWithReason()
    {
        ...
        var sut = new DeclineLecturerVerificationRequestCommandHandler(reqRepo, profileRepo, logger);
